<main>
    ...
    <div class = "table">
        <div class="grid-container1">
            <div class="grid-item1">Bat</div>
            <div class="grid-item1">Ball</div>
            <div class="grid-item1">Fish</div>  
            <div class="grid-item1">Cat</div>
            <div class="grid-item1">Owl</div>
            <div class="grid-item1">Car</div>  
            <div class="grid-item1">Film</div>
            <div class="grid-item1">Shoe</div>
            <div class="grid-item1">Bat</div> 
            <div class="grid-item1">Ball</div>
            <div class="grid-item1">Fish</div>
            <div class="grid-item1">Cat</div> 
...
<style>
    ...
    .grid-container2{
        ...
        grid-gap : 5px;
        background: #F2F2F2;
        box-shadow: 0px 7.22628px 0px #D8D7D7;
        border-radius: 8.67153px;
    }
    .gridMinus{
        background: #E9E9E9;
